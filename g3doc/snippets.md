...
func @matmul(%A: memref<?x?xf32, offset: ?, strides: [?, 1]>,
  ...
  %_ = "s.matmul" (%A, %B, %C) : memref<?x?xf32, offset: ?, strides: [?, 1]>, memref<?x?xf32, offset: ?, strides: [?, 1]>, memref<?x?xf32, offset: ?, strides: [?, 1]>
  return
}
```
...
```mlir {.mlir}
unc @matmul(%A: memref<?x?xf32, (d0, d1)[s0, s1] -> (d0 * s1 + s0 + d1)>, %B: memref<?x?xf32, (d0, d1)[s0, s1] -> (d0 * s1 + s0 + d1)>, %C: memref<?x?xf32, (d0, d1)[s0, s1] -> (d0 * s1 + s0 + d1)>) {
  ...
...
func @fusion_test(%A: memref<?x?xf32, (d0, d1)[s0, s1] -> (d0 * s1 + s0 + d1)>, %B: memref<?x?xf32, (d0, d1)[s0, s1] -> (d0 * s1 + s0 + d1)>, %C: memref<?x?xf32, (d0, d1)[s0, s1] -> (d0 * s1 + s0 + d1)>, %D: memref<?x?xf32, (d0, d1)[s0, s1] -> (d0 * s1 + s0 + d1)>, %E: memref<?x?xf32, (d0, d1)[s0, s1] -> (d0 * s1 + s0 + d1)>) {
  ...
  for %arg5 = %c0_0 to %6 step %c2000 {
    for %arg6 = %c0_1 to %7 step %c3000 {
      for %arg7 = %c0_2 to %8 step %c4000 {
  ...
  ...
  for %arg5 = %c0 to %9 step %c100 {
    for %arg6 = %c0 to %10 step %c150 {
...
func @fusion_test(%A: memref<?x?xf32, (d0, d1)[s0, s1] -> (d0 * s1 + s0 + d1)>, %B: memref<?x?xf32, (d0, d1)[s0, s1] -> (d0 * s1 + s0 + d1)>, %C: memref<?x?xf32, (d0, d1)[s0, s1] -> (d0 * s1 + s0 + d1)>, %D: memref<?x?xf32, (d0, d1)[s0, s1] -> (d0 * s1 + s0 + d1)>, %E: memref<?x?xf32, (d0, d1)[s0, s1] -> (d0 * s1 + s0 + d1)>) {
  ...
  for %arg5 = %c0 to %3 step %c100 {
    for %arg6 = %c0 to %4 step %c150 {
      ...
      ...
      for %arg7 = %c0_0 to %28 step %c2 {
        for %arg8 = %c0_1 to %29 step %c3 {
          for %arg9 = %c0_2 to %30 step %c4 {
